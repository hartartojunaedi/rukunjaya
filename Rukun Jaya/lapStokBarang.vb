...
Public Class lapStokBarang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.lapStokBarang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedlapStokBarang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lapStokBarang = New lapStokBarang()
        rpt.Site = Me.Site
        Return rpt
    End Function
