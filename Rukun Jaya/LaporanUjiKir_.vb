...
Public Class LaporanUjiKir_
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.LaporanUjiKir_.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanUjiKir_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanUjiKir_ = New LaporanUjiKir_()
        rpt.Site = Me.Site
        Return rpt
    End Function
