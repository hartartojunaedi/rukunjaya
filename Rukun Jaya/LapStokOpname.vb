...
Public Class LapStokOpname
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.LapStokOpname.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapStokOpname
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapStokOpname = New LapStokOpname()
        rpt.Site = Me.Site
        Return rpt
    End Function
