...
Public Class laporantotalanBaru
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.laporantotalanBaru.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedlaporantotalanBaru
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporantotalanBaru = New laporantotalanBaru()
        rpt.Site = Me.Site
        Return rpt
    End Function
