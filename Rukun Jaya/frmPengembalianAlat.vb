...
Public Class frmPengembalianAlat
    ...
    Private Sub frmPengembalianAlat_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub dgvPeminjaman_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvPeminjaman.CellClick
        If e.RowIndex >= 0 Then
            If (e.ColumnIndex = 0) Then '' delete
                frmdetilpengembalianAlat.idpinjam = dgvPeminjaman.Rows(e.RowIndex).Cells("nopeminjaman").Value
                '  frmdetilpengembalianAlat.panggil()
                frmdetilpengembalianAlat.ShowDialog()
                ...
                '        cmd.Connection = cn
                '        cmd.CommandText = "Update set tanggalkembali='" & Date.Today & "' from tdpeminjaman where nopeminjaman=@kode"
    ...
    Private Sub dgvPeminjaman_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvPeminjaman.CellContentClick
