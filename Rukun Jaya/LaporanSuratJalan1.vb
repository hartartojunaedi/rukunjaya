...
Public Class LaporanSuratJalan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.LaporanSuratJalan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanSuratJalan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanSuratJalan = New LaporanSuratJalan()
        rpt.Site = Me.Site
        Return rpt
    End Function
