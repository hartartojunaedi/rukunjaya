...
Public Class laporantotalan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.laporantotalan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporantotalan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporantotalan = New laporantotalan()
        rpt.Site = Me.Site
        Return rpt
    End Function
