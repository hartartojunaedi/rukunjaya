...
Public Class lapBukuMuatan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.lapBukuMuatan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedlapBukuMuatan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lapBukuMuatan = New lapBukuMuatan()
        rpt.Site = Me.Site
        Return rpt
    End Function
