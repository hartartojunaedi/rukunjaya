...
Public Class frmPemasukan
    ...
    End Sub
    Private Sub frmPemasukan_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        frmDetailPemasukan.tglawal = dtpAwal.Value
        frmDetailPemasukan.tglakhir = dtpAkhir.Value
        frmDetailPemasukan.perusahaan = cbPerusahaan.Text
        frmDetailPemasukan.ShowDialog()
    End Sub
