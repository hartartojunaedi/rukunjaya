...
Public Class LapHistoryHarga
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.LapHistoryHarga.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapHistoryHarga
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapHistoryHarga = New LapHistoryHarga()
        rpt.Site = Me.Site
        Return rpt
    End Function
