...
Public Class LaporanKendaraan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.LaporanKendaraan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_namapsh() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedLaporanKendaraan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanKendaraan = New LaporanKendaraan()
        rpt.Site = Me.Site
        Return rpt
    End Function
