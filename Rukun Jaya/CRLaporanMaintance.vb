...
Public Class CRLaporanMaintance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.CRLaporanMaintance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRLaporanMaintance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLaporanMaintance = New CRLaporanMaintance()
        rpt.Site = Me.Site
        Return rpt
    End Function
