...
Public Class LaporanMutasiMasuk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RukunJaya.LaporanMutasiMasuk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanMutasiMasuk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanMutasiMasuk = New LaporanMutasiMasuk()
        rpt.Site = Me.Site
        Return rpt
    End Function
